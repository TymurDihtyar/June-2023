...
let arr = ['hello', 'owu', 'com', 10, -999, 123, 3.14, 2.7, true, 32]
...
let book4 = {title: 'HarryPotter', pageCount: 380, genre: 'fantasy', authors: ['name', 'age']};
let book5 = {title: 'Astral', pageCount: 290, genre: 'horror', authors: ['name', 'age']};
let book6 = {title: 'TomasSoer', pageCount: 420, genre: 'artistic', authors: ['name', 'age']};
