...
var arr = ['hello', 'owu', 'com', 10, -999, 123, 3.14, 2.7, true, 32];
console.log(arr[0]);
console.log(arr[1]);
console.log(arr[2]);
console.log(arr[3]);
...
var time = Math.ceil(Math.random() * 59);
console.log(time);
if (0 <= time && time <= 15) {
...
if (coursesAndDurationArray[0].monthDuration > 5) {
    console.log("".concat(coursesAndDurationArray[0].title, ": \u0421\u0443\u043F\u0435\u0440"));
}
if (coursesAndDurationArray[1].monthDuration > 5) {
    console.log("".concat(coursesAndDurationArray[1].title, ": \u0421\u0443\u043F\u0435\u0440"));
}
if (coursesAndDurationArray[2].monthDuration > 5) {
    console.log("".concat(coursesAndDurationArray[2].title, ": \u0421\u0443\u043F\u0435\u0440"));
}
if (coursesAndDurationArray[3].monthDuration > 5) {
    console.log("".concat(coursesAndDurationArray[3].title, ": \u0421\u0443\u043F\u0435\u0440"));
}
if (coursesAndDurationArray[4].monthDuration > 5) {
    console.log("".concat(coursesAndDurationArray[4].title, ": \u0421\u0443\u043F\u0435\u0440"));
}
if (coursesAndDurationArray[5].monthDuration > 5) {
    console.log("".concat(coursesAndDurationArray[5].title, ": \u0421\u0443\u043F\u0435\u0440"));
}
